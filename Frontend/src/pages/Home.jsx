      ...
      <section className="py-16 bg-gray-200">
        ...
        <div className="flex overflow-x-auto space-x-8 m-10">
            <div className="bg-white p-6 rounded-lg shadow-lg flex-shrink-0">
                ...
                <button onClick={()=>{navigate('/productdetails')}} className="bg-blue-500 text-white font-bold py-2 px-4 rounded mb-2 mr-2">View Details</button>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg relative flex-shrink-0">
                ...
                <p className="text-lg font-semibold text-green-500 mb-2">39/- per bunch</p>
